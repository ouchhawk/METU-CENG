...
struct ext2_dir_entry {
    struct ext2_dir_entry *directory_list;
    struct ext2_dir_entry *file_list;
...
//CUSTOM DEFINITIONS BELOW

struct path {
    char parsed_path[10][255];
    int length;
};

struct ext2_super_block g_super_block;
struct ext2_block_group_descriptor* g_block_group_descriptors;
struct ext2_inode *g_initial_inode;
struct ext2_dir_entry g_dir_entry ;
struct path g_path;
int g_allocated_inode_number;
int FILE_DESCRIPTOR;
...
void print_inode_size(int inode_id);
